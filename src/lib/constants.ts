...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    summary:
      "A precision-engineered presence for a Kuwait-based medical equipment distributor — 25+ brand partners, 170+ product lines, 24/7 technical support.",
    challenge:
  ...
  },
  {
    ...
    challenge:
      "Wellness brands in the region either feel medical and clinical or fluffy and Instagram-y. LivFunctional needed the rare third register — rigorous, warm, and unapologetically modern.",
    approach:
  ...
  },
  {
    ...
    summary:
      "A clinical-grade aligner studio in Kuwait City — three-minute scans, real-time simulation, a treatment plan you can watch unfold tooth by tooth. Currently in build.",
    challenge:
