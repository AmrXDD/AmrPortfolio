...
/*
 * SideRays — animated volumetric light rays (adapted from reactbits.dev, ogl).
 * Renders a full-bleed WebGL shader of god-rays sweeping from a corner. Pauses
 * when off-screen. Colours are tuned per-usage.
 */
